...
export default ({ title, black, white, onClick, type = 'default' }) => {
    return (
        <div className={`ShareBtn ${black && 'ShareBtn_black'} ${white && 'ShareBtn_white'} ${['twitter', 'tg'].includes(type) && 'ShareBtn_social'}`} onClick={onClick}>
            {
                title
            }
            {
